...
export interface DeleteValueSetAction {
    type: typeof DELETE_VALUESET_ACTION;
    item: ValueSet;
}
...
export const deleteValueSetAction = (item: ValueSet): DeleteValueSetAction => {
    return {
        type: DELETE_VALUESET_ACTION,
        item
    };
}
